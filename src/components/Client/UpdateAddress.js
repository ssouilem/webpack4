...
const UpdateAddress = ({ item, onChange, handleOpen, modalOpen, handleClose, complete, submitMeetingForm, address }) => (
  <Modal
    ...
    <Modal.Content>
      { !complete
        ? <ItemAddress
          address={ address }
          onChange={ onChange }
          item={ { firstName: item.name, lastName: item.contactName } }
          disabled={ false }
        />
