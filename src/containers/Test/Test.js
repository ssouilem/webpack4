...
import { Form, Modal, Icon, Button, Image, dimmer } from 'semantic-ui-react'
        ...
        <Modal.Content>
          ...
          :
            <div className='modal-complete'>
              ...
              <p>Thanks for scheduling a meeting, {this.state.name}. We've received your information and we'll be in touch shortly.</p>
            </div>
          }
        </Modal.Content>
        {!this.state.complete ?
